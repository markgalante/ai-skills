...
| [`make-me-understand`](./make-me-understand/SKILL.md) | Manual-only explanation mode — numbered chunks with a specific check-in after each, one-word verdicts on questions, no walls of text |
